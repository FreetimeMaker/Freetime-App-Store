...
public class DE_CatClickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CatDbtn.setOnClickListener(v -> {
            String fileUrl = "https://github.com/FreetimeMaker/Cat-Clicker/releases/download/v1.0.8/Cat.apk"; // Direct APK link

            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(fileUrl));
            request.setTitle("Cat Clicker herunterladen");
            request.setDescription("Lade Cat Clicker herunter...");
