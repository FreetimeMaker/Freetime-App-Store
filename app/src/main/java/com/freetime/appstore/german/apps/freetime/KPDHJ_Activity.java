...
public class KPDHJ_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn.setOnClickListener(v -> {
            Intent intent = new Intent(KPDHJ_Activity.this, DE_MainActivity.class);
            startActivity(intent);
        });

        Button KPDHJDownBtn = findViewById(R.id.KPDHJDownBtn);
        KPDHJDownBtn.setOnClickListener(v -> {
            String fileUrl = "https://github.com/FreetimeMaker/K-Pop-Demon-Hunters-Java/releases/download/v1.1.1/KPDH.apk"; // Direct APK link
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
                request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "KPDH.apk");
            } else {
                // For Android 10+
                request.setDestinationInExternalFilesDir(getApplicationContext(), Environment.DIRECTORY_DOWNLOADS, "KPDH.apk");
            }
