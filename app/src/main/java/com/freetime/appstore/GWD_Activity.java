...
public class GWD_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDonateOxa.setOnClickListener(v -> {
            Intent intent = new Intent(GWD_Activity.this, GWDOxa_Activity.class);
            startActivity(intent);
        });

        Button btnDonateCoin = findViewById(R.id.btnDonateCoin);
        btnDonateCoin.setOnClickListener(v -> {
            Intent intent = new Intent(GWD_Activity.this, GWDCoin_Activity.class);
            startActivity(intent);
        });
    }
}